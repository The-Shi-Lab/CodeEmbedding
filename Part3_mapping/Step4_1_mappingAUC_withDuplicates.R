...
orgCos = read.csv(paste0("~/EHRmapping/mapping2/results/phecode_",phecode,"_",cosineType,"_withDuplicates.csv"),header = TRUE, row.names = 1)
truncatedCos = read.csv(paste0("~/EHRmapping/mapping2/results/phecode_",phecode,"_",cosineType,"_withDuplicates_thres.csv"),header = TRUE, row.names = 1)
...
write.csv(result,paste0("~/EHRmapping/mapping2/results/phecode_",phecode,"_",cosineType,"_withDuplicates_AUC.csv"),row.names = FALSE)
