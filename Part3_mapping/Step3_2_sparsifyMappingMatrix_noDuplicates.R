...
load(paste0(outpath,"phecode_",phecode,"_orgCosine_noDuplicates.RData"))
# load(paste0(outpath,"phecode_",phecode,"_refinedCosine_noDuplicates_freq.RData"))


coss = read.csv(paste0("/net/snowwhite/home/jiacong/EHRmapping/mapping2/results/phecode_401_",cosineType,"_noDuplicates.csv"),header = TRUE, row.names = 1)
...
y_hat=MGI_embeddings_aligned
y=UKB_embeddings_map
thres=thresholds
marginal=FALSE
UKB_freq_norm=UKB_freq
MGI_freq_norm=MGI_all
nfold=20
leaveOneOut=FALSE
