...
DataSource = 'Dx'
threshold=5
path = "/net/snowwhite/home/jiacong/EHRmapping/createUKBphenome/UKB_icdcode_thres5_digit1/"
...
# tmp <- read.csv(file=paste0(path,'New_CoOccurMatrix/threshold',threshold,'/CoOccurMatrix_1000.csv'))
tmp <- read.csv(file=paste0(path,'New_CoOccurMatrix/CoOccurMatrix_1000.csv'))
